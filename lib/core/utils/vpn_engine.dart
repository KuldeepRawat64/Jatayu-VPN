...
class Vpn {
  ///Channel to native
  static final String _eventChannelVpnStage = "com.animusit.jatayuvpn/vpnstage";
  static final String _eventChannelVpnStatus =
      "com.animusit.jatayuvpn/vpnstatus";
  static final String _eventChannelVpnStatusUpload =
      "com.animusit.jatayuvpn/vpnstatus";
  static final String _eventChannelVpnStatusDownload =
      "com.animusit.jatayuvpn/vpnstatus";
  static final String _methodChannelVpnControl =
      "com.animusit.jatayuvpn/vpncontrol";
  ...
  static Stream<VpnStatus> vpnStatusDownloadSnapshot() =>
      EventChannel(_eventChannelVpnStatusDownload)
          .receiveBroadcastStream()
          .map((event) => VpnStatus.fromJson(jsonDecode(event)))
          .cast();
  static Stream<VpnStatus> vpnStatusUploadSnapshot() =>
      EventChannel(_eventChannelVpnStatusUpload)
          .receiveBroadcastStream()
          .map((event) => VpnStatus.fromJson(jsonDecode(event)))
          .cast();
  static Stream<VpnStatus> vpnStatusSnapshot() =>
      EventChannel(_eventChannelVpnStatus)
          ...
          .map((event) => VpnStatus.fromJson(jsonDecode(event)))
          .cast();
  static Stream<VpnStatus> vpnStatusDurationSnapshot() =>
      EventChannel(_eventChannelVpnStatus)
          .receiveBroadcastStream()
          .map((event) => VpnStatus.fromJson(jsonDecode(event)))
          .cast();
